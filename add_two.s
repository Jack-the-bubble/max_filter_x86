...
one:	xor r15, r15			;calculate offset from beginning of table
tw:mov r15, r11
thr:	imul r15, r14
for:	add r15, r12
fiv:	xor rax, rax
six:	mov al, [rdi+r15]		;get value o pixel in mask on coordinates(row_iter, col_iter)

svn:	cmp eax, r13d
eit:	jle col_iter_continue	;if no bigger value found, continue without changing max

nin:	xor r13, r13
ten:	mov r13b, al			;if new checked value is bigger than max, replace
...
col_idx_continue:
	...
	cmp r10, r14
	jle col_idx_loop		;if col_idx == width*+3
